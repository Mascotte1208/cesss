    ...
    '3e': [

        {
            ...
            cours:`<h4>C'est quoi une fonction ?</h4>
                ...
                <p><b>Zéro d'une fonction</b> : là où la courbe coupe l'axe des x (f(x) = 0).
                <b>Ordonnée à l'origine</b> : là où elle coupe l'axe des y (x = 0).
                Une courbe qui monte de gauche à droite est croissante,
                qui descend est décroissante.</p>`,
...

        {
            ...
            cours:`<h4>C'est quoi un polynôme ?</h4>
                ...
                <p>Un polynôme est une somme de termes
                (ex : <b>2x² - 5x + 3</b>).
                Chaque terme est un produit d'un coefficient
                et d'une partie littérale.</p>
                ...
                <p><b>Exemple :</b>
                3x + 6 = 3(x + 2) — facteur commun 3.</p>

                <p><b>Méthode des rectangles :</b>
                pour x² + 5x + 6, on cherche deux nombres qui multipliés
                donnent 6 et additionnés donnent 5 : 2 et 3.
                Donc x² + 5x + 6 = (x + 2)(x + 3).</p>`,
...

        {
            ...
            cours:`<h4>Le théorème</h4>
                ...
                <p>Dans un triangle <b>rectangle</b>,
                le carré de l'hypoténuse (côté le plus long)
                ...
                <p>À calculer une longueur inconnue.
                <b>Exemple :</b> côtés 3 et 4 →
                3² + 4² = 25 → hypoténuse = √25 = 5.</p>

                <h4>Attention</h4>

                <p>La réciproque prouve qu'un triangle est rectangle :
                si a² + b² = c², le triangle est rectangle.</p>`,
...

        {
            ...
            cours:`<h4>Le théorème</h4>
                ...
                <p>Quand deux droites parallèles coupent
                deux droites sécantes, elles déterminent des segments
                de longueurs <b>proportionnelles</b>.</p>
                ...
                <p>À calculer une longueur inconnue,
                ou une distance inaccessible
                (hauteur d'une pyramide grâce à son ombre).</p>

                <h4>La réciproque</h4>

                <p>Si AB/AC = AD/AE,
                alors les droites BD et CE sont parallèles.</p>`,
...

        {
            ...
            cours:`<h4>Les 3 formules (SOH CAH TOA)</h4>
                ...
                <p>Pour la hauteur d'un arbre :
                Hauteur = Distance × tan(angle).</p>`,
    ...
    '4e': [

        {
            ...
            cours:`<h4>La forme générale</h4>
                ...
                <ul>
                    <li>Δ > 0 : 2 solutions</li>
                    <li>Δ = 0 : 1 solution</li>
...

        {
            ...
            cours:`<h4>Le produit scalaire</h4>
                ...
                <p>Le produit scalaire de deux vecteurs est un
                <b>nombre</b> :
                <b>u·v = ||u|| × ||v|| × cos(α)</b>.</p>

                <p>Si les vecteurs sont orthogonaux,
                leur produit scalaire vaut <b>0</b>.</p>`,
...

        {
            ...
            cours:`<h4>Paramètres de position</h4>
                ...
                <ul>
                    <li><b>Moyenne</b> : somme divisée par le nombre total.</li>
                    <li><b>Médiane</b> : valeur du milieu une fois rangées.</li>
                ...
                <ul>
                    ...
                    <li><b>Écart-type (σ)</b> : racine carrée de la variance.</li>
                </ul>

                <h4>Boîte à moustaches</h4>

                <p>Elle visualise Q1, la médiane (Q2),
                Q3, ainsi que le min et le max.</p>`,
...

        {
            ...
            cours:`<h4>La fonction affine</h4>

                <p><b>f(x) = mx + p</b> :
                m est la pente (croissante si m>0),
                p est l’ordonnée à l’origine.</p>

                <h4>La fonction quadratique</h4>

                <p><b>f(x) = a(x-k)² + h</b> :
                parabole de sommet (k, h).
                Si a>0, elle ouvre vers le haut.</p>

                <h4>Effet des paramètres</h4>

                <p>Changer a, k ou h déplace ou déforme
                le graphique sans changer sa nature.</p>`,
...

        {
            ...
            cours:`<h4>Représenter l’espace sur une feuille</h4>
                ...
                <p>Deux techniques principales :
                la <b>perspective cavalière</b>
                (les droites parallèles restent parallèles,
                pratique pour les solides simples)
                et la <b>perspective centrale</b>
                (les lignes convergent vers un point de fuite,
                plus réaliste).</p>
                ...
                <ul>
                    <li><b>Deux droites</b> :
                    sécantes, parallèles, ou <b>gauches</b>.</li>

                    <li><b>Une droite et un plan</b> :
                    la droite est incluse dans le plan,
                    sécante au plan, ou parallèle au plan.</li>

                    <li><b>Deux plans</b> :
                    sécants ou parallèles.</li>
                </ul>

                <h4>Point de percée et section plane</h4>

                <p>Le <b>point de percée</b> d’une droite dans un plan
                est le point où la droite traverse ce plan.
                Une <b>section plane</b> est la figure obtenue
                en coupant un solide par un plan.</p>`,
            ...
            exercices:[
                ...
                {
                    question:'Dans quelle perspective les droites parallèles restent-elles parallèles sur le dessin ?',
                    options:[
                    ...
                    correct:0,
                    correction:'C’est la propriété caractéristique de la perspective cavalière.'
                }
            ]
        },

        {
            ...
            cours:`<h4>Le cercle trigonométrique</h4>
                ...
                <p>C’est un cercle de <b>rayon 1</b>
                centré à l’origine.
                Pour un angle α, le point correspondant
                sur le cercle a pour coordonnées
                <b>(cos α, sin α)</b>.</p>
                ...
                <p>Et aussi :
                <b>tan(α) = sin(α) / cos(α)</b>.</p>

                <h4>Résoudre un triangle quelconque</h4>

                <ul>
                    <li><b>Aire d’un triangle</b> :
                    Aire = (1/2) × a × b × sin(C).</li>

                    <li><b>Relation des sinus</b> :
                    a/sin(A) = b/sin(B) = c/sin(C).</li>

                    <li><b>Théorème d’Al-Kashi</b> :
                    a² = b² + c² - 2bc·cos(A).</li>
                </ul>`,
            ...
            exercices:[
                ...
                },
                {
                    ...
                    correct:0,
                    correction:'Quand l’angle A vaut 90°, on retrouve Pythagore.'
                }
            ]
        }
    ...
    '5e': [

        {
            ...
            cours:`<h4>L'idée intuitive</h4>
                ...
                <p>La limite décrit ce que devient f(x)
                quand x se rapproche d'une valeur
                ou de l'infini.</p>

                <h4>Les formes indéterminées</h4>

                <p>Ce sont les cas où on ne peut pas conclure directement :
                <b>0/0</b>, <b>∞/∞</b>, <b>∞ - ∞</b>, <b>0 × ∞</b>.</p>

                <h4>Asymptotes</h4>

                <p>Si lim f(x) = L quand x → ∞,
                la droite y = L est une
                <b>asymptote horizontale</b>.</p>`,
...

        {
            ...
            cours:`<h4>Le taux de variation</h4>
                ...
                <p>Le taux de variation moyen entre a et b :
                <b>(f(b) - f(a)) / (b - a)</b>.</p>

                <h4>Le nombre dérivé</h4>

                <p>La dérivée f'(a) est la limite de ce taux
                quand b se rapproche de a :
                elle donne la <b>pente de la tangente</b>.</p>
...

        {
            ...
            cours:`<h4>Pourquoi les complexes ?</h4>
                ...
                <p>Pour donner un sens à √(-1).
                On pose <b>i² = -1</b>,
                et tout nombre complexe s'écrit
                <b>z = a + bi</b>.</p>

                <h4>Le module</h4>

                <p><b>|z| = √(a² + b²)</b> :
                c'est la distance entre le point z
                et l'origine dans le plan complexe.</p>

                <h4>Opérations</h4>

                <p>On additionne et multiplie les complexes
                comme des polynômes,
                en remplaçant i² par -1.</p>`,
...

        {
            ...
            cours:`<h4>L'équation d'une droite</h4>
                ...
                <p><b>y = mx + p</b>,
                où m est la pente :
                <b>m = (y_B - y_A) / (x_B - x_A)</b>.</p>

                <h4>Distance entre deux points</h4>

                <p><b>d(A,B) = √[(x_B - x_A)² + (y_B - y_A)²]</b>.</p>

                <h4>L'équation d'un cercle</h4>

                <p>Un cercle de centre (a, b)
                et de rayon r :
                <b>(x - a)² + (y - b)² = r²</b>.</p>`,
...

        {
            ...
            cours:`<h4>Étudier deux caractères à la fois</h4>
                ...
                <p>Quand on mesure deux grandeurs
                sur les mêmes individus,
                on obtient une <b>série statistique à deux variables</b>,
                représentée par un <b>nuage de points</b>.</p>

                <h4>Le point moyen et la droite de Mayer</h4>

                <p>Le <b>point moyen</b> G a pour coordonnées
                (x̄, ȳ).</p>

                <h4>Le coefficient de corrélation</h4>

                <p>Il mesure à quel point les points sont alignés,
                entre <b>-1 et 1</b>.</p>

                <h4>Attention : corrélation ≠ causalité !</h4>

                <p>Deux séries peuvent être corrélées
                sans que l’une soit la cause de l’autre.</p>`,
            ...
            exercices:[
                ...
                },
                {
                    ...
                    options:[
                        ...
                        'Oui, toujours',
                        'Seulement si le coefficient est négatif',
                        'Seulement en statistique à une variable'
                    ],
                    correct:0,
                    correction:'La corrélation ne prouve pas la causalité.'
                }
            ]
        },

        {
            ...
            cours:`<h4>Du triangle au réel</h4>
                ...
                <p>En 4e, sin/cos/tan étaient définis
                pour des angles.
                En 5e, on les voit comme des
                <b>fonctions réelles</b>.</p>

                <h4>Les graphiques</h4>

                <p>Les fonctions sin et cos sont
                <b>périodiques de période 2π</b>.
                Elles oscillent entre -1 et 1.</p>

                <h4>Amplitude, période, déphasage</h4>

                <p>Pour f(x) = a·sin(bx + c) :
                <b>a</b> est l’amplitude,
                <b>2π/b</b> est la période.</p>

                <h4>Résoudre une équation trigonométrique</h4>

                <p>Pour résoudre sin(x) = k,
                on utilise le cercle trigonométrique.</p>`,
            ...
            exercices:[
                ...
                },
                {
                    ...
                    correct:0,
                    correction:'Dans a·sin(bx), a est l’amplitude : ici a = 3.'
                }
            ]
        }
    ...
    '6e': [

        {
            ...
            cours:`<h4>Règles de dérivation</h4>
                ...
                <p>Si <b>f'(x) > 0</b>, f est croissante.
                Si <b>f'(x) < 0</b>, f est décroissante.</p>

                <h4>Tableau de variation</h4>

                <p>Il résume le signe de f'
                et le sens de variation de f.</p>`,
...

        {
            ...
            cours:`<h4>La primitive</h4>
                ...
                <p>F est une primitive de f si <b>F' = f</b>.
                C'est l'opération inverse de la dérivation.</p>
...

        {
            ...
            cours:`<h4>Probabilité conditionnelle</h4>
                ...
                <p><b>P(A|B) = P(A ∩ B) / P(B)</b></p>

                <h4>Événements indépendants</h4>

                <p>A et B sont indépendants si
                <b>P(A ∩ B) = P(A) × P(B)</b>.</p>

                <h4>Loi binomiale</h4>

                <p>Elle modélise le nombre de succès
                sur n répétitions indépendantes.</p>`,
...

        {
            ...
            cours:`<h4>Variable aléatoire</h4>
                ...
                <p>Une <b>variable aléatoire</b>
                associe un nombre à chaque résultat possible.</p>

                <h4>La loi binomiale</h4>

                <p>Elle modélise le nombre de succès
                dans une répétition de n épreuves de Bernoulli.</p>

                <h4>La loi normale</h4>

                <p>C’est la fameuse
                <b>courbe en cloche</b>,
                symétrique autour de la moyenne.</p>`,
            ...
            exercices:[
                ...
                {
                    question:'L’espérance mathématique d’une variable aléatoire représente…',
                    options:[
                        'Sa moyenne théorique',
                        'Sa valeur maximale',
                        'Sa probabilité totale',
                        'Son écart-type'
                    ],
                    correct:0,
                    correction:'L’espérance est la valeur moyenne attendue en théorie.'
                }
            ]
        },

        {
            ...
            cours:`<h4>La fonction exponentielle</h4>
                ...
                <p><b>f(x) = eˣ</b>
                est toujours positive et strictement croissante.</p>

                <h4>La fonction logarithme</h4>

                <p><b>ln(x)</b> est la fonction réciproque
                de l’exponentielle.</p>
            ...
            exercices:[
                ...
                {
                    question:'Pour x très grand, quelle fonction croît le plus vite ?',
                    options:[
                        'eˣ',
                        'ln(x)',
                        'x²',
                    ...
                    correct:0,
                    correction:'L’exponentielle domine les puissances et le logarithme pour x grand.'
                }
            ]
        },

        {
            ...
            cours:`<h4>Se repérer dans l’espace</h4>
                ...
                <p>Un point de l’espace a
                <b>trois coordonnées (x, y, z)</b>.</p>

                <h4>Équations d’une droite et d’un plan</h4>

                <p>Une <b>droite</b> est définie par un point
                et un vecteur directeur.
                Un <b>plan</b> peut être défini par une équation
                <b>ax + by + cz + d = 0</b>.</p>

                <h4>Positions relatives et distances</h4>

                <p>Deux droites peuvent être sécantes,
                parallèles ou <b>gauches</b>.</p>`,
            ...
            exercices:[
                ...
                {
                    question:'Deux droites de l’espace ni sécantes ni parallèles sont dites…',
                    options:[
                        'Gauches',
                        'Orthogonales',
                        'Confondues',
                    ...
                    correct:0,
                    correction:'Dans l’espace, elles sont dites gauches.'
                }
            ]
        }
...
var FORMULES_DATA = {
    ...
    geometrie: [
...

        {
            ...
            definition:'AB/AC = AD/AE (si BD // CE)',
...

        {
            ...
            definition:'y = mx + p, avec m = (yB-yA)/(xB-xA)',
    ...
    trigonometrie: [
...

        {
            id:'trigo_6',
            annee:'4e',
            titre:'Tangente = sinus/cosinus',
            definition:'tan(α) = sin(α) / cos(α)',
            exemple:'sin(45°)=cos(45°) → tan(45°)=1',
            icone:'📐',
            categorie:'Trigonométrie'
        },

        {
            ...
            definition:'Pour f(x)=a·sin(bx+c) : amplitude=|a|, période=2π/b',
    ...
    geoEspace: [

        {
            id:'espace_1',
            annee:'6e',
            titre:'Distance dans l’espace',
            definition:'d = √[(xB-xA)² + (yB-yA)² + (zB-zA)²]',
